...
def vhan_dashboard():
    ...
    """)
    open_inquiries_count = cursor.fetchone()['total']
...
@vhan_bp.route('/vhan/inquiries/<int:inquiry_id>/status', methods=['POST'])
def update_inquiry_status(inquiry_id):
    ...
    return redirect(url_for(
        'vhan.support_inquiries',
        status=request.form.get('selected_status', ''),
        source=request.form.get('selected_source', '')
    ))


@vhan_bp.route('/vhan/inquiries/<int:inquiry_id>/details', methods=['POST'])
...
@vhan_bp.route('/vhan/inquiries/<int:inquiry_id>/correct-profile', methods=['POST'])
...
@vhan_bp.route('/vhan/inquiries/<int:inquiry_id>/send-response', methods=['POST'])
...
@vhan_bp.route('/vhan/inquiries/<int:inquiry_id>/correct-registration-email', methods=['POST'])
